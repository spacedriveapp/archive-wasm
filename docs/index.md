...
- [archive-wasm](#module_archive-wasm)
  ...
  - _inner_
    - [~EntryTypeName](#module_archive-wasm..EntryTypeName) : <code>module:archive~EntryTypeName</code>
...
<a name="module_archive-wasm..EntryTypeName"></a>

### archive-wasm~EntryTypeName : <code>module:archive~EntryTypeName</code>
...
| type      | <code>module:archive~EntryTypeName</code> | Indicates if the entry is a file, directory or something else                                                      |
